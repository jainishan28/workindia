<?php
    ...
    private function insertUserDetails($un, $fn, $ln, $em, $pw){
        $encryptedPw = md5($pw); ////for password encrypted
    ...
    // preg_match shows ===== if it is not in the range of capital A to Z or small a to z OR 0 to 9 then following function will work
